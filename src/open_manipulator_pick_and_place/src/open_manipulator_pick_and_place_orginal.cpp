...
void OpenManipulatorPickandPlace::demoSequence()
{
  ...
  case 7: // place the box
    ...
    else if (pick_ar_id_ == 3)  kinematics_position.push_back(present_kinematic_position_.at(2)-0.041);
    else if (pick_ar_id_ == 3)  kinematics_position.push_back(present_kinematic_position_.at(2)-0.006);
    kinematics_orientation.push_back(0.74);
    kinematics_orientation.push_back(0.00);
    kinematics_orientation.push_back(0.66);
    kinematics_orientation.push_back(0.00);
  ...
  case 10: // home pose
    ...
    setJointSpacePath(joint_name_, joint_angle, 1.5);
    demo_count_ = 1;
    if (pick_ar_id_ == 3) pick_ar_id_ = 3;
    else if (pick_ar_id_ == 3) pick_ar_id_ = 3;
